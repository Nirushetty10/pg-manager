      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/invite/:type" element={<InviteRegisterPage />} />
            <Route path="/select-pg" element={<ProtectedRoute allowedRoles={['owner']}><PGSelectPage /></ProtectedRoute>} />

            {/* Master Admin */}
            <Route path="/admin" element={<ProtectedRoute allowedRoles={['master_admin']}><MasterLayout /></ProtectedRoute>}>
              <Route index element={<MasterDashboard />} />
              <Route path="owners" element={<MasterOwners />} />
              <Route path="owners/:id" element={<OwnerDetail />} />
            </Route>

            {/* PG-scoped (Owner + Staff) */}
            <Route path="/pg/:pgId" element={<ProtectedRoute allowedRoles={['owner','manager','staff']}><OwnerLayout /></ProtectedRoute>}>
