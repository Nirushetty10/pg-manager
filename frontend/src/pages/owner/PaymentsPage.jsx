...
function OutstandingTable({ ledger, onRecord, canCreate }) {
  ...
  // Show ANY tenant who owes money — current month OR previous months
...
export default function PaymentsPage() {
  ...
  /* ── tenants who need payment — includes prev_balance only tenants ── */
  ...
  const isPartialRow = (p) => p.is_partial || safeNum(p.balance_due) > 0;
  const paidPct = (p) => {
                  ...
                  {payments.map((p) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          <StatusChip
                            status={partial ? 'partial' : p.status || 'settled'}
                          />
                        </TableCell>
                        <TableCell>
      ...
      >
        ...
        <DialogContent sx={{ pt: 1 }}>
          ...
          <Grid container spacing={2} sx={{ mt: 0 }}>
            {/* Tenant dropdown — shows ALL tenants with any outstanding dues */}
            <Grid item xs={12}>
